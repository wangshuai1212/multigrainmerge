...
template <bool is_ad>
InputParameters
GrainGBEvolutionBaseTempl<is_ad>::validParams()
{
...
template <bool is_ad>
GrainGBEvolutionBaseTempl<is_ad>::GrainGBEvolutionBaseTempl(const InputParameters & parameters)
...
template class GrainGBEvolutionBaseTempl<false>;
template class GrainGBEvolutionBaseTempl<true>;

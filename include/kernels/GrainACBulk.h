 ...
 */
template <typename T>
class GrainACBulk : public DerivativeMaterialInterface<JvarMapKernelInterface<KernelValue>>
{
public:
  GrainACBulk(const InputParameters & parameters);
...
template <typename T>
GrainACBulk<T>::GrainACBulk(const InputParameters & parameters)
...
template <typename T>
Real
GrainACBulk<T>::precomputeQpResidual()
{
...
template <typename T>
Real
GrainACBulk<T>::precomputeQpJacobian()
{
...
template <typename T>
Real
GrainACBulk<T>::computeQpOffDiagJacobian(unsigned int jvar)
{

...
#include "GrainPolycrystalColoringIC.h"
...
registerMooseObject("multigrainmergeApp", GrainPolycrystalColoringIC);

InputParameters
GrainPolycrystalColoringIC::validParams()
{
...
GrainPolycrystalColoringIC::GrainPolycrystalColoringIC(const InputParameters & parameters)
...
Real
GrainPolycrystalColoringIC::value(const Point & p)
{
  if (_current_node)

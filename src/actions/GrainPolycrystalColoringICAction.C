...
#include "GrainPolycrystalColoringICAction.h"
#include "Factory.h"
#include "FEProblem.h"
#include "Conversion.h"
#include "PolycrystalICTools.h"

registerMooseAction("multigrainmergeApp", GrainPolycrystalColoringICAction, "add_ic");

InputParameters
GrainPolycrystalColoringICAction::validParams()
{
...
GrainPolycrystalColoringICAction::GrainPolycrystalColoringICAction(const InputParameters & params)
  : Action(params),
...
void
GrainPolycrystalColoringICAction::act()
{
  // Loop through the number of order parameters
  for (unsigned int op = 0; op < _op_num; op++)
  {
    // Set parameters for BoundingBoxIC
    InputParameters poly_params = _factory.getValidParams("GrainPolycrystalColoringIC");
    ...
    _problem->addInitialCondition(
        "GrainPolycrystalColoringIC", "GrainPolycrystalColoringIC_" + Moose::stringify(op), poly_params);
  }
}

...
template <bool is_ad>
class GrainGBEvolutionBaseTempl : public DerivativeMaterialInterface<Material>
{
public:
  static InputParameters validParams();

  GrainGBEvolutionBaseTempl(const InputParameters & parameters);
...
typedef GrainGBEvolutionBaseTempl<false> GrainGBEvolutionBase;
typedef GrainGBEvolutionBaseTempl<true> ADGrainGBEvolutionBase;

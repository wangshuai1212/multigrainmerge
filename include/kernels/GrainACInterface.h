 ...
 */
class GrainACInterface : public DerivativeMaterialInterface<JvarMapKernelInterface<Kernel>>
{
public:
  static InputParameters validParams();

  GrainACInterface(const InputParameters & parameters);
...
protected:
  ...
  const MaterialProperty<Real> & _mo1; //Mobility-c
